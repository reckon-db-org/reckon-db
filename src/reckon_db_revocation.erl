...
-define(TOKEN_TABLE, reckon_db_revoked_tokens).
-define(ISSUER_TABLE, reckon_db_revoked_issuers).
...
%% Tests are in test/unit/reckon_db_revocation_tests.erl
